...
export const I18N = {
    ...
    list: [
      {
        ...
        name: 'Benkyou 勉強',
        year: '2026 — now',
        tagline: { es: 'Plataforma amable para empezar con el japonés — hiragana y katakana con repaso espaciado. Sin cuenta y offline.', en: 'Friendly platform to get started with Japanese — hiragana and katakana with gentle spaced repetition. No account, offline.' },
  ...
  writing: {
    ...
    all: { es: 'ver todos los escritos', en: 'see all writing' },
  },
